...
#########################################################################################################
describe "assignement of network ID terminations when added to a connection if either or both terminations are involved in a prior support relations with terminations" do
