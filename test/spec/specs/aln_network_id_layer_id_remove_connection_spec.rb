...
#########################################################################################################
describe "assignement of network ID and layer ID for terminations after deatching from a connection where the terminations are not involved in another connection and may have supported" do
...
##########################################################################################################
describe "assignement of network ID and layer ID for terminations after deatching from a connection where the terminations are involved in connections with more than 1 other termination and may have supported" do
...
###########################################################################################################
describe "assignement of network ID and layer ID for terminations after deatching from a connection where multiple supported terminations at different layers are involved in connections with 1 other termination" do
