...
#
  it "should leave all termination in same network and maximum layer ID of network should not change" do 
    ...
    #### validate final configuration network id 
    check_network_id(EthernetTermination, eth1.id, tcp3.network_id)
    check_network_id(EthernetTermination, eth4.id, tcp3.network_id)
    check_network_id(IpTermination, ip1.id, tcp3.network_id)
    check_network_id(IpTermination, ip2.id, tcp3.network_id)
    check_network_id(IpTermination, ip3.id, tcp3.network_id)
    check_network_id(IpTermination, ip4.id, tcp3.network_id)
    check_network_id(TcpSocketTermination, tcp1.id, tcp3.network_id)
    check_network_id(TcpSocketTermination, tcp2.id, tcp3.aln_termination.id)
    check_network_id(TcpSocketTermination, tcp3.id, tcp3.network_id)
    check_network_id(TcpSocketTermination, tcp4.id, tcp3.network_id)
